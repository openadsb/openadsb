...
class Bootloader(object):
	def __init__(self, vid=VID, pid=PID, app_vid=APP_VID, app_pid=APP_PID):
		self.dev = usb.core.find(idVendor=app_vid, idProduct=app_pid)
		if self.dev:
			print "Invoking bootloader..."
	...
	def enter_bootloader(self):
		self.dev.ctrl_transfer(0x40|0x80, REQ_BOOTLOADER, 0, 0, 0)
